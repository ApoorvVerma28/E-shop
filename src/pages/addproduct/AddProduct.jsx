                ...
                <div className=' bg-gray-300 px-10 py-10 rounded-xl '>
                    ...
                    <div>
                       ...
                       onChange={(e) => setProducts({ ...products, description: e.target.value })}
                            className=' bg-white h-10 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-black  placeholder:text-black outline-none'
                    ...
                    <div className=' flex justify-center mb-3'>
                        <button
                         onClick={addProduct}
                            className=' bg-[#088178] hover:bg-[#1a5a56ee] w-full text-white font-bold active:scale-105 px-2 py-2 rounded-lg'>
                            Add Product
                        </button>
                    </div>
